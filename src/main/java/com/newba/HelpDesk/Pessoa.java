...
public class Pessoa  implements Serializable{
    ...
    @ElementCollection(fetch = FetchType.EAGER) // serve para segurar que a lista de perfis vem junto com usuario
    @CollectionTable(name ="PERFIS") // serve para criar uma tabela no banco com nome perfis
