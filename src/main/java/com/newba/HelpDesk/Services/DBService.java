...
public class DBService {
    ...
    public void instanciaDB(){
        Tecnico tec1 = new Tecnico(null, "Newba", "04340538132", "kleveson_x3@hotmail.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);

		Cliente cli1 = new Cliente(null, "Linus Torvals", "33136537742", "torval@email.com", encoder.encode("123"));
